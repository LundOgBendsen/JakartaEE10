package dk.university.adm.enrollment.boundary.model;
...
public class Subject {
	...
	public void setStuderende(List<Student> student) {
		this.student = student;
	}

	
	
	public Studyboard getStudienaevn() {
		return studyboard;
	}

	public void setStudienaevn(Studyboard studyboard) {
