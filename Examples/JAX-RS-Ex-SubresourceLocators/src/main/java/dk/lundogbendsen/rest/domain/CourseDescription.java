...
public class CourseDescription {
	...
	@Path("events/{index}")
	public CourseEvent getCourse(@PathParam("index") String index) {
	...
	public void setCourses(List<CourseEvent> courses) {
		this.courses = courses;
	}

	private List<CourseEvent> courses = new ArrayList<CourseEvent>();
