...
public class InitializeDatabaseBean {
	...
	public void init() {
		...
		double calories = recipeService.calculateCalories(pancakes);
		log.info("Calories in pancakes: " + calories);
...
//		
//		RecipeIngredient riFlour = new RecipeIngredient();
//		riFlour.setIngredient(flour);
//		riFlour.setQuantity(1);
//		bread.getIngredients().add(riFlour);
//		
//		RecipeIngredient riMilk = new RecipeIngredient();
//		riMilk.setIngredient(milk);
//		riMilk.setQuantity(2);
//		bread.getIngredients().add(riMilk);
//		
//		log.info("Start building recipe via gateway");
//		gateway.create(bread);
//		gateway.getCurrent().getIngredients().add(riFlour);
//		riFlour.setRecipe(bread);
//		gateway.getCurrent().getIngredients().add(riMilk);
//		riMilk.setRecipe(bread);
//		gateway.save();
//		log.info("Finished building recipe via gateway");
